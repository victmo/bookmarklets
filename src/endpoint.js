...
(function(){
	...
	if(
		(/(realsimple.com|travelandleisure.com|coastalliving.com|health.com|foodandwine.com|southernliving.com|cookinglight.com|sunset.com|essence.com)/)
	...
	if(
		(/(ew.com|people.com|peopleenespanol.com)/)
		.test(location.hostname)
	){
	...
	if(
		...
		location.href = 'http://time.com/api/v2/extra-crispy/article/' + utag_data.content_id;
	}
