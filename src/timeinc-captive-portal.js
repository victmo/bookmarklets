...
(()=>{
    ...
    s += 'input{ font-size: 26px; font-weight: bold; border: 1px solid #ccc; width: 100%; padding: 16px; border-radius: 4px; box-sizing: border-box; }';
